...
CREATE TABLE t_job_log  (
                              ...
                              CREATE_TIME datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                              PRIMARY KEY (LOG_ID)
) ENGINE = InnoDB AUTO_INCREMENT = 2562 ROW_FORMAT = Dynamic;
...
CREATE TABLE t_log  (
                          ...
                          PRIMARY KEY (ID)
) ENGINE = InnoDB AUTO_INCREMENT = 1008 ROW_FORMAT = Dynamic;
...
CREATE TABLE t_login_log  (
                                ...
                                LOCATION varchar(50) NULL DEFAULT NULL COMMENT '登录地点',
                                ...
                                PRIMARY KEY (ID)
) ENGINE = InnoDB AUTO_INCREMENT = 70 ROW_FORMAT = Dynamic;
...
CREATE TABLE t_menu  (
                           ...
                           MODIFY_TIME datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                           PRIMARY KEY (MENU_ID)
) ENGINE = InnoDB AUTO_INCREMENT = 178 ROW_FORMAT = Dynamic;
...
CREATE TABLE t_role  (
                           ...
                           MODIFY_TIME datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                           PRIMARY KEY (ROLE_ID)
) ENGINE = InnoDB AUTO_INCREMENT = 81 ROW_FORMAT = Dynamic;
...
CREATE TABLE t_user  (
                           ...
                           SSEX char(1) NULL DEFAULT NULL COMMENT '性别 0男 1女 2保密',
                           IS_TAB char(1) NULL DEFAULT NULL COMMENT '是否开启tab，0关闭 1开启',
